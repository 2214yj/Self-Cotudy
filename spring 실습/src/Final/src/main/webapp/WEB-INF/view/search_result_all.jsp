...
<section style="padding: 100px 60px 20px 60px">
    <c:if test="${empty searchResult}">
        ...
        <a href="/search/all?searchType=최신순">최신순</a>
        <a href="/search/all?searchType=오래된순">오래된순</a>
        <a href="/search/all?searchType=저렴한순">저렴한순</a>
        <a href="/search/all?searchType=비싼순">비싼순</a>
        <a href="/search/all?searchType=인기순">인기순</a>
        <br>
    </c:if>
    <c:if test="${! empty searchResult}">
        <br>
