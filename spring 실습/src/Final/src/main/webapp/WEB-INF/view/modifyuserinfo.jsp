...
<c:if test="${! empty authInfo}">
    ...
    <section style="padding: 100px 60px 20px 60px">
        <h2><spring:message code="modifyuserinfo"/></h2>
        <form:form action="/modifyUserInfo/${authInfo.userid}" modelAttribute="info">
            <p><label> <spring:message code="email"/>:<br> <form:input path="email"/> <form:errors path="email"/>
            </label></p>
            <p><label> <spring:message code="addr"/>:<br> <form:input path="addr"/> <form:errors path="addr"/> </label>
            </p>
